            ...
            <div className="mb-8">
              ...
              <div className="space-x-4">
                ...
                <button
                  ...
                  className="border border-gray-300 dark:border-gray-600 hover:border-red-500 dark:hover:border-red-400 hover:text-red-500 dark:hover:text-red-400 text-gray-700 dark:text-gray-300 px-6 py-3 rounded-full font-medium transition-all duration-300 hover:shadow-md transform hover:-translate-y-0.5"
                >
              ...
              <div>
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-300">hello@funneleffect.com</p>
                    </div>
                  </div>
                ...
                <div className="mt-8">
                  ...
                  <div className="flex space-x-4">
                    <a href="#" className="w-10 h-10 bg-gray-100 dark:bg-gray-700 hover:bg-red-500 dark:hover:bg-red-500 rounded-full flex items-center justify-center transition-colors duration-300 group">
